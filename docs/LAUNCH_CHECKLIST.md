...
2. If Supabase room persistence is enabled, apply `202608030001_auth_persistence.sql`, `202608050001_workspace.sql`, and `202608260001_guest_database_only.sql` in that order; apply later analytics/GitHub migrations only for those optional server features.
