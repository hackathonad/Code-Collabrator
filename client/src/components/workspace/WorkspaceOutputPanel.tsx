...
const EmptyState = ({ text }: { text: string }) => <p className="rounded-lg border border-dashed border-[var(--border)] px-3 py-4 text-[11px] leading-5 text-[var(--text-faint)]">{text}</p>;
